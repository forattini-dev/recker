...
Recker provides intelligent connection pooling powered by undici's Agent for optimal HTTP performance.
...
- [Batch Requests Guide](/guides/batch-requests.md) - Batch operations with connection pooling
- [HTTP/2 Guide](/guides/client-config.md#http2-configuration) - HTTP/2 configuration
- [Observability](/guides/observability.md) - Monitor connection reuse
