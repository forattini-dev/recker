...
Recker provides a full-featured WebSocket client built on top of Undici's WebSocket implementation, with automatic reconnection, heartbeat/ping support, and both event-based and async iterator APIs.
