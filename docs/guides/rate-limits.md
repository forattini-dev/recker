...
- Combine with [Retry & Backoff](/guides/advanced/retry.md) for 429/503 handling.
- Surface TaskPool metrics via `client.batch` + [Observability](/guides/observability/observability.md) to watch throughput and queueing. 
